...
def reset_cfg(cfg, args):
    ...
    if args.forget_model:
        cfg.MODEL.FORGET_PATH = args.forget_model
...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.TaskRes.RESIDUAL_SCALE = 0.5 # 0.5 #1.0
    ...
    # TCP
    print("cfg.TRAINER.NAME", args.trainer)
    if args.trainer in ['TCP', 'KgCoOp', 'ProGrad', 'SEP', 'SEPRES']:
        cfg.TRAINER.COOP.CTX_INIT = False 
        cfg.TRAINER.COOP.W = 1.0
    
    # if args.trainer in ['SEPRES']:
        # cfg.TRAINER.COOP.SEPRES_ALPHA = 0.1
    ...
    # if cfg.MODEL.FORGET_PATH == 'empty':
    #     cfg.MODEL.FORGET_PATH = ""
    #     print("cfg.MODEL.FORGET_PATH ", cfg.MODEL.FORGET_PATH )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--forget_model", type=str, default="", help="name of CNN backbone")
    parser.add_argument(
    ...
    print(f"NUMBER AVAILABLE CUDA DEVICES FOR {args.trainer} IS {torch.cuda.device_count()}")
