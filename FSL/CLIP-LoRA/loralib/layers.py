...
class PlainMultiheadAttentionLoRA(nn.Module):
    def __init__(
        ...
        # Changed this as not available in Pytorch 1.13
        self.scaled_dot_product_attention = scaled_dot_product_attention #torch.nn.functional._scaled_dot_product_attention # scaled_dot_product_attention #F.scaled_dot_product_attention
    ...
    def forward_module(
        ...
        # attn_output = self.scaled_dot_product_attention(q, k, v, attn_mask, dropout_p)
